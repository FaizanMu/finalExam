...
public class writeingScores : MonoBehaviour
{
    ...
    public void AddNewScore()
    {
        ...
        NewName.text = NameScript.myPlayerName;

        pointCounter pc = FindObjectOfType<pointCounter>();
        newScore = pc.count.ToString();

        //newScore = pointCounter.count;
